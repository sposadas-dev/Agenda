...
public class Vista
{
	...
	private void initialize() 
	{
		...
		spPersonas.setBounds(10, 11, 556, 182);
		...
		btnAgregar.setBounds(10, 228, 113, 23);
		panel.add(btnAgregar);
		
	    btnEditar = new JButton("Editar");
		btnEditar.setBounds(158, 228, 89, 23);
		panel.add(btnEditar);
		
		btnBorrar = new JButton("Borrar");
		btnBorrar.setBounds(280, 228, 89, 23);
		panel.add(btnBorrar);
		
		btnReporte = new JButton("Reporte");
		btnReporte.setBounds(424, 228, 113, 23);
